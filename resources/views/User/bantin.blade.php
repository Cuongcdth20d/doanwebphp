...
<form action="{{ route('ban-tin') }}" method="POST" class="form index">
                ...
                <div class="row tm-row">
                    <div class="col-12">
                        <form action="{{route('sreach')}}" method="GET" class="form-inline tm-mb-80 tm-search-form">
                            <input class="form-control tm-search-input" name="sreach" type="text"
                    ...
                    <div class="col-lg-6 tm-mb-60 tm-person-col">
                        <div class="media tm-person">
                            ...
                            <div class="media-body">
                                <ul>
                                    <li>
                                        <h2 class="tm-color-primary tm-post-title mb-2">{{$ListPost->tieude}}</h2>
                                    </li>
                            ...
                            <div>
                                <a href="/chi-tiet-tin/{{($ListPost->id)}}"> Chi Tiết</a>
                            </div>
