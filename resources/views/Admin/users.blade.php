...
<form action="{{ route('ql-user') }}" method="POST" class="form index">
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <main class="tm-main">
                <!-- Search form -->
                <h2 style="text-align:center"> <b>Danh Sách Người Dùng </b> </h2>
                ...
                <div>
                    ...
                    <table style="width:100%">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center">{{$ListPost->username}}</th>
                            <th style="text-align: center">{{$ListPost->Adress}}</th>
                            <th style="text-align: center">{{$ListPost->phone}}</th>
                            <th style="text-align: center">{{$ListPost->email}}</th>
                            <th style="text-align: center">{{$ListPost->date}}</th>
                            @if($ListPost->loaitk==null)                            
                                <th style="text-align: center"> <a href="/xoa-user/{{$ListPost->id}}"> Xóa</a></th>
                                <th style="text-align: center"> <a href="/chi-tiet-user/{{($ListPost->id)}}"> Hồ Sơ </a></th>   
                                @endif
                        </tr>
                        @endforeach
                    </table>
