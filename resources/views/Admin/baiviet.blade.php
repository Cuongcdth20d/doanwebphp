...
<form action="{{ route('ql-bai') }}" method="POST" class="form index">
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <main class="tm-main">
                <!-- Search form -->
                <h2 style="text-align:center"> <b>Danh sách bài đăng </b> </h2>
                ...
                <div>
                    ...
                    <table style="width:100%">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center">{{$ListPost->loai}}</th>
                            <th style="text-align: center">{{$ListPost->phone}}</th>
                            <th style="text-align: center">{{$ListPost->ngaymat}}</th>
                            <th style="text-align: center"> <a href="/xoa-bai-viet/{{$ListPost->id}}"> Xóa</a></th>
                            <th style="text-align: center"> <a href="/chi-tiet-bai-viet/{{($ListPost->id)}}"> Xem Chi
                                    Tiết</a></th>
                        </tr>
                        @endforeach
                    </table>
